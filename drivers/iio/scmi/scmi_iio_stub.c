...
static struct scmi_sensor_info accel_info = {
	...
	.scale = 5,
	.async = true,
	.name = "Acclerometer", // TODO(jbhayana) : change the sensor name to scmi.iio.accel (b/155128197 )
	.num_trip_points = 0,
	.update = true,
	.timestamped = true,
	.tstamp_scale = -9,
...
static struct scmi_sensor_info gyro_info = {
	...
	.scale = 2,
	.async = true,
	.name = "Gyroscope", // TODO(jbhayana) : change the sensor name to scmi.iio.gyro (b/155128197)
	.num_trip_points = 0,
	.update = true,
	.timestamped = true,
	.tstamp_scale = -9,
